...
<%
String deptids=request.getParameter("desnname");
String str;
try
{
	...
	str="delete from designation where desn_name='"+deptids+"'";
	pstmt=con.prepareStatement(str);
	pstmt.executeUpdate();
%>
	<center>
	<h2>Record Deleted Successfully .....
	<a href="JDesignationWiseReport.jsp">Click Here To Go Back</a>
	</h2>
	</center>
