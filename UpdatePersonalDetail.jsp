...
<head>
	...
	function saving()
	{
	document.UpdatePersonalDetail.action="UpdatePersonalDetails.jsp";
	document.UpdatePersonalDetail.submit();
	}
	</script>
	</head>
<%@ include file="EHeader.jsp"%>
	<form method="POST" action="UpdatePersonalDetails.jsp" name="SaveTransferRequest" onsubmit="return validate();">       
<head>
...
<center>
    ...
    <hr>
    <h2> <font color="#800000"></font>Update Employee Details</h2> 
    <table bgcolor="white">
<br>
<tr>
<td></td>
...
<tr>
<td></td>
        <td><font color="#800000"><b>Mobile</b></font><font color="#800000" size=""><b></b></font><font color="#800000" size=""><b></b></font><font color="#800000" size="">&nbsp;</font></td>
...
<table>
 <tr>
    <td><input type="submit" name="save" value="Update" onClick="saving()"></td>
