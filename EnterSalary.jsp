...
<head>
	...
	function saving()
	{
	document.UpdateUserDetails.action="UpdateUser.jsp";
	document.UpdateUserDetails.submit();
	}
	</script>
	</head>
<%@ include file="Header.jsp" %>
<form method="POST" action="SaveSalary.jsp" name="SaveSalary" onsubmit="return validate();">
...
<center>
    ...
    <hr>
    <h2> <font color="#800000"></font>Enter Employee Salary Details</h2> 
    <table bgcolor="white">
<tr>
<td></td>
...
<tr>
<td></td>
        <td><font color="#800000"><b>Otheres</b></font><font color="#800000" size=""><b></b></font><font color="#800000" size=""><b></b></font><font color="#800000" size="">&nbsp;</font></td>
