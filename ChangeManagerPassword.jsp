...
<head>
	...
	function saving()
	{
	document.ChangeManagerPassword.action="ChangeManagerPwd.jsp";
	document.ChangeManagerPassword.submit();
	}
	</script>
	</head>
<%@ include file="Header.jsp" %>	
<form method="POST" action="ChangeManagerPwd.jsp" name="ChangeManagerPwd" onsubmit="return validate();">      
<head><title>Employee Personal Master</title></head>
<body bgcolor="#FFFFCC">
