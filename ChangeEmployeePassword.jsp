...
<head>
	...
	function saving()
	{
	document.ChangeEmployeePassword.action="ChangeEmployeePwd.jsp";
	document.ChangeEmployeePassword.submit();
	}
	</script>
	</head>
<%@ include file="EHeader.jsp"%>						
<form method="POST" action="ChangeEmployeePwd.jsp" name="ChangeEmployeePwd" onsubmit="return validate();">       
<head>
