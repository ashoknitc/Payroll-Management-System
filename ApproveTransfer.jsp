...
<head>
	...
	function saving()
	{
	document.ApproveTransfer.action="ApproveTransferRequest.jsp";
	document.ApproveTransfer.submit();
	}
	</script>
	</head>
...
<table>
 <tr>
    <td><input type="submit" name="save" value="Approve" onClick="saving()"></td>
