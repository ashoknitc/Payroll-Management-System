...
<div id="art-page-background-glare">
    ...
    <div id="art-main">
        <div class="art-sheet">
           ...
           <form method="POST" name="HLogin" id="HLogin" valign="top" action="ELogin.jsp" onsubmit="return validate();">
          <table width="100%" height="200" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="white">
            <tr>
            <th>&nbsp;</th>
              <th  align="left">&nbsp;</th>
              <th align="left"><span style="color:red; font-size:12px" align="center">Login Form</span></th>
            </tr>
            <tr>
              <td width="10%" height="41" align="left" >     </td>
              <td width="2%"> User Id </td>
              <td width="10%">
              <input name="uid" id="uid" type="text" id="uid" size="35" required="required"></td>
            </tr>
            <tr>
              <td height="41" width="10%" align="left">     </td>
              <td width="2%">Password</td>
              <td>
              <input name="pwd" type="password" id="pwd" size="35"  required="required"></td>
            </tr>
