...
<form method="POST" action="JDelMgrRecord.jsp" name="JDelMgrRecord" onsubmit="return validate();">      
<head>
...
<td></td>
        <td><font color="#800000">&nbsp;</font><font color="#800000"><b>Manager ID</b></font><font color="#800000" size="">&nbsp;</font></td>
        <td><%@ include file="FetchMgrId.jsp" %></td>
<td></td>
</tr>
</table>
</br>
...
<table>
 <tr>
    <td><a href="EmpRecord.jsp"><input type="button" name="Back" value="Back"></a></td>
